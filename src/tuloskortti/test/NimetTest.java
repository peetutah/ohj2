 ...
 * @version 2021.04.21 14:59:52 // Generated by ComTest
 *
 */
...
public class NimetTest {
  ...
  // Generated by ComTest BEGIN
  /** testGetJuoksevaId266 */
  @Test
  public void testGetJuoksevaId266() {    // Nimet: 266
    Nimet koe = new Nimet(); 
    Nimi f = new Nimi(6, "F"); 
    Nimi c = new Nimi(3, "C"); 
    Nimi d = new Nimi(4, "D"); 
    ...
    Nimi g = new Nimi(7, "G"); 
    Nimi h = new Nimi(8, "H"); 
    assertEquals("From: Nimet line: 276", 0, koe.getJuoksevaId()); 
    koe.lisaa(b); 
    koe.lisaa(e); 
    koe.lisaa(c); 
    assertEquals("From: Nimet line: 280", 5, koe.getJuoksevaId()); 
    koe.lisaa(d); 
    koe.lisaa(a); 
    assertEquals("From: Nimet line: 283", 5, koe.getJuoksevaId()); 
    koe.lisaa(h); 
    koe.lisaa(f); 
    koe.lisaa(g); 
    assertEquals("From: Nimet line: 287", 8, koe.getJuoksevaId()); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testAnna306() throws IndexOutOfBoundsException {    // Nimet: 306
    Nimet koe = new Nimet(); 
    Nimi n3 = new Nimi(3, "Kolmas"); 
    Nimi n1 = new Nimi(1, "eka"); 
    Nimi n2 = new Nimi(2, "toinen"); 
    koe.lisaa(n1); 
    try {
    assertEquals("From: Nimet line: 313", null, koe.anna(1)); 
    fail("Nimet: 313 Did not throw IndexOutOfBoundsException");
    } catch(IndexOutOfBoundsException _e_){ _e_.getMessage(); }
    koe.lisaa(n3); 
    koe.lisaa(n2); 
    assertEquals("From: Nimet line: 316", "1|eka", koe.anna(0).toString()); 
    assertEquals("From: Nimet line: 317", "3|Kolmas", koe.anna(1).toString()); 
    assertEquals("From: Nimet line: 318", "2|toinen", koe.anna(2).toString()); 
    try {
    assertEquals("From: Nimet line: 319", null, koe.anna(3)); 
    fail("Nimet: 319 Did not throw IndexOutOfBoundsException");
    } catch(IndexOutOfBoundsException _e_){ _e_.getMessage(); }
  } // Generated by ComTest END
  ...
  /** testEtsiNimi336 */
  @Test
  public void testEtsiNimi336() {    // Nimet: 336
    Nimet koe = new Nimet(); 
    Nimi n3 = new Nimi(3, "Kolmas"); 
    Nimi n1 = new Nimi(1, "eka"); 
    Nimi n2 = new Nimi(2, "toinen"); 
    ...
    koe.lisaa(n3); 
    koe.lisaa(n2); 
    assertEquals("From: Nimet line: 344", "1|eka", koe.etsiNimi(1).toString()); 
    assertEquals("From: Nimet line: 345", "3|Kolmas", koe.etsiNimi(3).toString()); 
    assertEquals("From: Nimet line: 346", "2|toinen", koe.etsiNimi(2).toString()); 
    assertEquals("From: Nimet line: 347", null, koe.etsiNimi(0)); 
  } // Generated by ComTest END
  ...
  /** testEtsiPaikka364 */
  @Test
  public void testEtsiPaikka364() {    // Nimet: 364
    Nimet koe = new Nimet(); 
    Nimi n1 = new Nimi(1, "eka"); 
    Nimi n2 = new Nimi(2, "toinen"); 
    Nimi n3 = new Nimi(3, "Kolmas"); 
    ...
    koe.lisaa(n3); 
    koe.lisaa(n2); 
    assertEquals("From: Nimet line: 372", 0, koe.etsiPaikka(1)); 
    assertEquals("From: Nimet line: 373", 2, koe.etsiPaikka(2)); 
    assertEquals("From: Nimet line: 374", 1, koe.etsiPaikka(3)); 
    assertEquals("From: Nimet line: 375", -1, koe.etsiPaikka(0)); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testTallenna390() throws IOException {    // Nimet: 390
    ...
    assertEquals("From: Nimet line: 407", false, talKoe.getMuutoksia()); 
    talKoe.tallenna(); 
    assertEquals("From: Nimet line: 409", "Tiedosto ei aukea: nKoe.dat", VertaaTiedosto.vertaaFileString("nKoe.dat",tulos)); 
    ...
    assertEquals("From: Nimet line: 416", true, talKoe.getMuutoksia()); 
    talKoe.tallenna(); 
    assertEquals("From: Nimet line: 418", null, VertaaTiedosto.vertaaFileString("nKoe.dat",tulos)); 
    assertEquals("From: Nimet line: 419", false, talKoe.getMuutoksia()); 
    Nimi uusi = new Nimi(11,"Yksvielä"); 
    talKoe.lisaa(uusi); 
    talKoe.tallenna(); 
    assertEquals("From: Nimet line: 423", "Rivi 9: Jono loppui ensin, nKoe.dat on 11|Yksvielä", VertaaTiedosto.vertaaFileString("nKoe.dat",tulos)); 
    VertaaTiedosto.tuhoaTiedosto("nKoe.dat"); 
   ...
   */
  @Test
  public void testLueTiedosto452() throws IOException {    // Nimet: 452
    VertaaTiedosto.tuhoaTiedosto("nKoe.dat"); 
    ...
    assertEquals("From: Nimet line: 470", false, lukuKoe.getMuutoksia()); 
    assertEquals("From: Nimet line: 471", 0, lukuKoe.getlkm()); 
    lukuKoe.lueTiedosto(); 
    assertEquals("From: Nimet line: 473", 6, lukuKoe.getlkm()); 
    assertEquals("From: Nimet line: 474", 20, lukuKoe.getJuoksevaId()); 
    assertEquals("From: Nimet line: 475", true, lukuKoe.getMuutoksia()); 
    assertEquals("From: Nimet line: 476", "4|Nelonen", lukuKoe.etsiNimi(4).toString()); 
    Nimi[]td = lukuKoe.getAlkiot(); 
    assertEquals("From: Nimet line: 478", "1|Ykkönen", td[0].toString()); 
    assertEquals("From: Nimet line: 479", "20|ToistKyt", td[5].toString()); 
    VertaaTiedosto.tuhoaTiedosto("nKoe.dat"); 
    VertaaTiedosto.tuhoaTiedosto("nKoe.bak"); 
  } // Generated by ComTest END
  ...
  /** testPoista511 */
  @Test
  public void testPoista511() {    // Nimet: 511
    Nimet koe = new Nimet(); 
    Nimi n3 = new Nimi(3, "Kolmas"); 
    Nimi n1 = new Nimi(1, "eka"); 
    Nimi n2 = new Nimi(2, "toinen"); 
    ...
    koe.lisaa(n3); 
    koe.lisaa(n2); 
    assertEquals("From: Nimet line: 519", 3, koe.getlkm()); 
    assertEquals("From: Nimet line: 520", 1, koe.poista(1)); 
    assertEquals("From: Nimet line: 521", 0, koe.poista(1)); 
    assertEquals("From: Nimet line: 522", 2, koe.getlkm()); 
    assertEquals("From: Nimet line: 523", true, koe.getMuutoksia()); 
    assertEquals("From: Nimet line: 524", 1, koe.poista(2)); 
    assertEquals("From: Nimet line: 525", 1, koe.getTosiMaara()); 
    assertEquals("From: Nimet line: 526", 2, koe.getlkm()); 
  } // Generated by ComTest END
}